...
API_ID = os.environ.get('API_ID','9220084')
API_HASH = os.environ.get('API_HASH','79dfb4f6a166b2d36a80d5595cfac7c1')
BOT_TOKEN = os.environ.get('BOT_TOKEN','5407418388:AAHxRe8U3VJlzuNPlB-Xc7w94zuoWeYDrxE')
...
ADMIN_CHATS = os.environ.get('ADMIN_CHATS','-1001247689862')
